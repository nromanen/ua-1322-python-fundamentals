...
38.Namespaces are one honking great idea -- let's do more of 
those!Beautiful is better than ugly.
...
# Display all text in uppercase and replace all occurrences
# of the symbol “i” with “&”.
print(python_philosophy.upper().replace('I', '&'))

# Display the number of occurrences of the words "better",
# "never" and "is" in the given line.
print(f"The word 'better' occurs - {python_philosophy.count('better')} times.",
      f"The word 'never' occurs - {python_philosophy.count('never')} times.",
      f"The word 'is' occurs - {python_philosophy.count('is')} times.",
      sep='\n')
