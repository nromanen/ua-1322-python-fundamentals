...
BETTER = TEXT_SPLITED.count("better")
NEVER = TEXT_SPLITED.count("never")
IS = TEXT_SPLITED.count("is")
print(f"Word Better have {BETTER} occurences")
print(f"Word Never have {NEVER} occurences")
print(f"Word Is have {IS} occurences")  
print(TEXT_UPPER)
print(TEXT_REPLACED)
